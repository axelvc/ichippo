	...
	return (
		<div className={cn('relative', className)}>
			<select
				...
				className="w-full appearance-none bg-zinc-800 border border-zinc-700 px-3 py-2 pr-10 text-xs font-mono text-zinc-200 focus:outline-none focus:border-purple-500 focus:ring-1 focus:ring-purple-500 cursor-pointer"
			>
				{placeholder && (
