...
const baseStyles =
	'cursor-pointer inline-flex items-center justify-center font-mono font-medium focus:outline-none focus:ring-2 focus:ring-accent-500 focus:ring-offset-2 focus:ring-offset-zinc-900 disabled:opacity-50 disabled:cursor-not-allowed border border-transparent'
